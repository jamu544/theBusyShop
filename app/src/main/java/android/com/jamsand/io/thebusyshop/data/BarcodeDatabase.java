...
public abstract class BarcodeDatabase extends RoomDatabase {
    ...
    private static class PopulateDbTaskAsync extends AsyncTask<Void,Void,Void> {
        ...
        //    Barcode(int id,String barcodeName, String description, String image, int price)
            barcodeDao.insert( new Barcode(1,"BAN258","Banana","banana.jpg",2.0));
            barcodeDao.insert( new Barcode(2,"APL883","Apple","apple.jpg",5.0));
            barcodeDao.insert( new Barcode(3,"SBR101","Strawberry","strawberry.jpg",0.5));
            barcodeDao.insert( new Barcode(4,"ORN750","Orange","orange.jpg",4.75));
            barcodeDao.insert( new Barcode(5,"WML999","Waterlemon","watermelon.jpg",38.0));
            barcodeDao.insert( new Barcode(6,"GPF208","Grapefruit","grapefruit.jpg",3.5));
            barcodeDao.insert( new Barcode(7,"PER478","Pear","pear.jpg",5.0));
            barcodeDao.insert( new Barcode(8,"COC378","Coconut","coconut.jpg",14.0));
            return null;
        }
    }
